            ...
            <div class="row justify-content-between align-items-center mb-3">
                <div class="col-10 offset-1 d-flex align-items-center justify-content-between justify-content-md-end">
                    ...
                    <div class="all-button-box">
                        <a href="{{ route('retainer.pdf', Crypt::encrypt($retainer->id))}}" class="btn btn-primary" target="_blank">{{__('Download')}}</a>
                    </div>
                </div>
            </div>
        @endif
                        ...
                        <div class="invoice-print">
                            <div class="row invoice-title mt-2">
                                ...
                                <div class="col-xs-12 col-sm-12 col-nd-6 col-lg-6 col-12 text-end">
                                    <h3 class="invoice-number">{{ Utility::retainerNumberFormat($company_setting,$retainer->retainer_id) }}</h3>
                                </div>
                                <div class="col-12">
                                    <hr>
                                </div>
                                    ...
                                    <div class="table-responsive mt-2">
                                        <table class="table mb-0 ">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-end">{{utility::priceFormat($company_setting,$retainer->getSubTotal())}}</td>
                                            </tr>
                                            @if($retainer->discount_apply==1)
                                                <tr>
                                                    <td colspan="6"></td>
                                                    <td class="text-end"><b>{{__('Discount')}}</b></td>
                                                    <td class="text-end">{{utility::priceFormat($company_setting,$retainer->getTotalDiscount())}}</td>
                                                </tr>
                                            @endif
                                            @if(!empty($taxesData))
                                            ...
                                            <tr>
                                                ...
                                                <td class="blue-text text-end">{{utility::priceFormat($company_setting,$retainer->getTotal())}}</td>
                                            </tr>
                                            </tfoot>
                                        </table>
                                    </div>
